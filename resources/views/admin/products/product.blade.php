...
<main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4">
            ...
            <div class="card-header pb-0">
              <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="form-inline">
                      ...
                      <select class="form-control" id="perPage" onchange="changePerPageProducts(this.value)">
                          <option value="5" {{ $perPageProducts == 5 ? 'selected' : '' }}>5</option>
                          <option value="10" {{ $perPageProducts == 10 ? 'selected' : '' }}>10</option>
                          <option value="15" {{ $perPageProducts == 15 ? 'selected' : '' }}>15</option>
                          <option value="20" {{ $perPageProducts == 20 ? 'selected' : '' }}>20</option>
                      </select>
                  </div>
              </div>
          </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">{{$item->view}}</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">{{$item->created_at}}</span>
                      </td>
                      <td class="align-middle">
                        <a class="btn btn-link text-danger text-gradient px-3 mb-0" href=""{{ route('delete_product', $item->id) }}" onclick="event.preventDefault(); document.getElementById('delete_product-{{ $item->id }}').submit();">
                          <i class="far fa-trash-alt me-2"></i>Xoá</a>
                        <form id="delete_product-{{ $item->id }}" action="{{ route('delete_product', $item->id) }}" method="POST" style="display: none;">
                          @csrf
                          @method('DELETE')
                      </form>
                      <a class="btn btn-link text-dark px-3 mb-0" href="{{route('update_products', ['id' => $item->id])}}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Sửa</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
      ...
      <a href="{{asset('add_products')}}"><button type="submit" class="btn btn-success">Thêm</button></a>
    </div>
