    ...
    <div class="container-fluid py-4">
      <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
          <li class="nav-item p-2" role="presentation">
              <a class="nav-link {{ $currentTab == '1' ? 'active' : '' }} bg-danger text-white" id="ex1-tab-1" data-bs-toggle="tab" href="#ex1-tabs-1" role="tab" aria-controls="ex1-tabs-1" aria-selected="{{ $currentTab == '1' ? 'true' : 'false' }}" data-tab="1">Đơn cần duyệt</a>
          </li>
          <li class="nav-item p-2" role="presentation">
              <a class="nav-link {{ $currentTab == '2' ? 'active' : '' }} bg-warning text-white" id="ex1-tab-2" data-bs-toggle="tab" href="#ex1-tabs-2" role="tab" aria-controls="ex1-tabs-2" aria-selected="{{ $currentTab == '2' ? 'true' : 'false' }}" data-tab="2">Đang giao</a>
          </li>
          <li class="nav-item p-2" role="presentation">
              <a class="nav-link {{ $currentTab == '3' ? 'active' : '' }} bg-success text-white " id="ex1-tab-3" data-bs-toggle="tab" href="#ex1-tabs-3" role="tab" aria-controls="ex1-tabs-3" aria-selected="{{ $currentTab == '3' ? 'true' : 'false' }}" data-tab="3">Đã nhận</a>
          </li>
          <li class="nav-item p-2" role="presentation">
              <a class="nav-link {{ $currentTab == '4' ? 'active' : '' }} bg-dark text-white " id="ex1-tab-4" data-bs-toggle="tab" href="#ex1-tabs-4" role="tab" aria-controls="ex1-tabs-4" aria-selected="{{ $currentTab == '4' ? 'true' : 'false' }}" data-tab="4">Đã huỷ</a>
          </li>
      </ul>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex px-2 py-1">
                              <div>
                                <div style="text-center">{{ Str::limit($needs->madth, 5)}}</div>
                              </div>
                              <div class="d-flex flex-column justify-content-center"></div>
                            </div>
                          </td>
                          <td>
                            <p class="mb-0 text-center">{{$needs->nguoidat_ten}}</p>
                          </td>
