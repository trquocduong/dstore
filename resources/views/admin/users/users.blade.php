...
<main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4">
            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-inline">
                        ...
                        <select class="form-control" id="perPage" onchange="changePerPage(this.value)">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tên và Email</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a class="btn btn-link text-danger text-gradient px-3 mb-0" href=""{{ route('delete_user', $user->id) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $user->id }}').submit();">
                          <i class="far fa-trash-alt me-2"></i>Xoá</a>
                        <form id="delete-form-{{ $user->id }}" action="{{ route('delete_user', $user->id) }}" method="POST" style="display: none;">
                          @csrf
                          @method('DELETE')
                      </form>
                        <a class="btn btn-link text-dark px-3 mb-0" href="{{route('update', ['id' => $user->id])}}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Sửa</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
      ...
      <a href="{{route('user.add')}}"><button type="submit" class="btn btn-success">Thêm</button></a>
    </div>
