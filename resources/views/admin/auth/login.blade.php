...
<section class="bg-light p-3 p-md-4 p-xl-5">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-12 col-xxl-11 d-flex align-items-center justify-content-center">
                  ...
                  {{-- <div class="row">
                    <div class="col-12">
                      <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center mt-5">
                        <a href="{{asset('register')}}" class="link-secondary text-decoration-none">Đăng Ký Ngay </a>
                        <a href="#!" class="link-secondary text-decoration-none">Tìm Tài Khoản</a>
