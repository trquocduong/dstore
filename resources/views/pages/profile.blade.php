                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="diachi" id="inputLocation" type="text" placeholder="Nhập địa chỉ" value="{{$user->diachi}}">
                        </div>
                    </div>
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="dienthoai" id="inputPhone" type="tel" placeholder="Nhập số điện thoại" value="{{$user->dienthoai}}">
                        </div>
                    </div>
                    <!-- Save changes button-->
